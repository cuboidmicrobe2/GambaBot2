...
use Gamba\CoinGame\Games\Example\TestGame;
...
$discord->listenCommand('testname', function(Interaction $interaction) use ($discord, $gamba) {

    $uid = getUserId($interaction);
    $inventory = $gamba->inventoryManager->getInventory($uid);
    $userCoins = $inventory->getCoins();
    $wager = getOptionValue('int', $interaction);
