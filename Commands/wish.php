...
$gachaBot->discord->listenCommand('wish', function (ApplicationCommand $interaction) use ($gachaBot): void {
    ...
    if ($items instanceof ItemCollection) {
        ...
        foreach ($items as $item) {
            $embeds[] = new Embed($gachaBot->discord)->setTitle($item->name)->setColor($item->rarity->getColor());
        }
